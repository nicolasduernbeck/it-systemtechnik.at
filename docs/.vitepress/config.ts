      ...
      '/': [
        {
          ...
          items: [
            { text: 'Einführung', link: '/netzwerktechnik/' },
            {
              text: 'OSI-Modell',
              collapsed: true,
              items: [
                { text: 'Einführung', link: '/netzwerktechnik/osi/' },
            ...
            },
            {
              ...
              collapsed: true,
              items: [
                { text: 'Einführung', link: '/netzwerktechnik/topologien/' },
                { text: 'Stern-Topologie', link: '/netzwerktechnik/topologien/stern' },
                { text: 'Bus-Topologie', link: '/netzwerktechnik/topologien/bus' },
                // { text: 'Ring-Topologie', link: '/netzwerktechnik/topologien/ring' },
                // { text: 'Maschen-Topologie', link: '/netzwerktechnik/topologien/maschen' },
                // { text: 'Baum-Topologie', link: '/netzwerktechnik/topologien/baum' },
              ],
            },
          ],
          collapsed: true,
